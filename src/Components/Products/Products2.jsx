...
export const Products2 = () => {
  return (
    <>
    <div className='bg-[#ECF6FF] text-[#02339B] font-bold text-2xl text-center rounded-t-[15px] w-[98%] m-auto '>
        <h2 className='pb-5' >2-Day Delivery on Grocery!</h2>
        <img className='rounded-b-[15px] overflow-hidden' src={banner1} alt="" />
    </div>

    <div className="flex text-center gap-7 m-5">
        <div className="card  bg-[#FCCF7F] rounded-[10px]  rounded-t-[10px]  " >
            <h2 className='p-2'>Discover Swimwear</h2>
            <img src={c1} alt="" />
            <div className='h-5 rounded-b-[10px] bg-[#DADDFE]' ></div>
        </div>
        <div className="card bg-[#FCCF7F]  rounded-[10px] rounded-t-[10px]  ">
            <h2 className='p-2'>Ladies'Shorts And Skorts</h2>
            <img src={c2} alt="" />
            <div className='h-5 rounded-b-[10px] bg-[#C6FDEA]' ></div>
        </div>
        <div className="card bg-[#FCCF7F]  rounded-[10px] rounded-t-[10px]  ">
            <h2 className='p-2'>Men's Polos and Shorts</h2>
            <img src={c3} alt="" />
            <div className='h-5 rounded-b-[10px] bg-[#B6DFFF]' ></div>
        </div>
    </div>

    <div className='bg-[#00549C] text-center text-white 
    w-[97%] rounded-t-[10px] m-auto mb-5 mt-5 ' >
        <h2 className='text-[19px] font-bold' >MEMBER-ONLY VALUE</h2>
        <img src={banner2} alt="" />
        <div className=' bg-[#E1E1E1] text-black rounded-b[10px] p-3 '>
            <h2 className='text-[13px]' >MORE PRODUCTS AND BRANDS</h2>
        </div>
    </div>

    <div className="2d flex gap-8 m-5">
        <div className="2cards bg-[#D32029] rounded-[10px] ">
        ...
        <div className="2cards bg-[#000000] rounded-[10px] ">
